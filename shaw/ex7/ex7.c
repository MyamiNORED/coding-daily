...
int main(int argc, char *argv[])
{
   ...
   unsigned long     univers_of_defects =100000000L*1024L*1024L*1024L*1024L * 1L * 1024L * 1024L * 1024L*1024L; 
   printf("The entire univers has %ld  bugs.", univers_of_defects);
